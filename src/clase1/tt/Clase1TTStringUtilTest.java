...
public class Clase1TTStringUtilTest {
    ...
    void testFill() {
        ...
        TestUtil.assertStringArraysContainSameElements(TestUtil.STRING_SORTED_BY_LENGTH_FILLED_1, sortedByLengthFilledStrings);
    }

    @Test
    void testToSortedByLengthStringArray() {
        final String[] sortedByLengthUnfilledStrings = StringUtil.toSortedByLengthStringArray(TestUtil.INT_UNSORTED_UNFILLED_1);
        TestUtil.assertStringArraysContainSameElements(TestUtil.STRING_SORTED_BY_LENGTH_UNFILLED_1, sortedByLengthUnfilledStrings);
    }
